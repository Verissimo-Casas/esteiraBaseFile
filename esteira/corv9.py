...
line_pos2 = int(2 * cap.get(cv2.CAP_PROP_FRAME_HEIGHT) / 5.8)

# Minimum separation between the lines
min_separacion = 20  # Adjust this value as needed
...
while True:
    ...
    if ret:
        ...
        cv2.putText(frame, 'Amarillo: {}'.format(objetos_amarillo[0]), (10, 40), font, 0.7, (0, 255, 255), 1, cv2.LINE_AA)
        cv2.putText(frame, 'Rojo: {}'.format(objetos_rojo[0]), (10, 60), font, 0.7, (0, 0, 255), 1, cv2.LINE_AA)
        cv2.putText(frame, 'Total: {}'.format(total_objetos[0]), (10, 80), font, 0.7, (255, 255, 255), 1, cv2.LINE_AA)
